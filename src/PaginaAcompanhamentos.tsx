    ...
    <>
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          <div>
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-blue-400/10 px-3 py-1 ring-1 ring-blue-400/15">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-wider text-blue-300">Acompanhamento</span>
            </div>
            <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              ACOMPANHAMENTOS <span className="bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">Ativos</span>
            </h1>
            <p className="mt-2 text-sm text-blue-200/60">
              Acompanhe o progresso e as consultas dos seus pacientes.
            </p>
          </div>
          <div className="flex items-center gap-4">
            <div className="rounded-xl bg-white/[0.06] px-5 py-3 ring-1 ring-white/[0.08] backdrop-blur-sm">
              <p className="text-[10px] font-semibold uppercase tracking-wider text-blue-300/70">Total Acompanhamentos</p>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white py-16 text-center">
          <p className="text-lg font-semibold text-slate-400">Nenhum acompanhamento ainda</p>
          <p className="mt-1 text-sm text-slate-300">Inicie um acompanhamento para acompanhar o progresso do paciente.</p>
        </div>
      </div>
    </>
  );
